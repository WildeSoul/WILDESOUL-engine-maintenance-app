...
sns.countplot(data=df, x='Engine_Condition', hue='Engine_Condition', palette={0:'#2ecc71', 1:'#e74c3c', '0':'#2ecc71', '1':'#e74c3c'}, legend=False)
...
for i, col in enumerate(num_cols):
    sns.histplot(data=df, x=col, hue='Engine_Condition', kde=True, ax=axes[i], palette={0:'#2ecc71', 1:'#e74c3c', '0':'#2ecc71', '1':'#e74c3c'})
...
axes = axes.flatten()
for i, col in enumerate(num_cols):
    sns.boxplot(data=df, y=col, x='Engine_Condition', ax=axes[i], palette={0:'#2ecc71', 1:'#e74c3c', '0':'#2ecc71', '1':'#e74c3c'})
